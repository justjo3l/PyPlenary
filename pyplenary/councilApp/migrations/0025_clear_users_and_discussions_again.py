...
def clear_users_and_discussions(apps, schema_editor):
    ...
    Speaker = apps.get_model('councilApp', 'Speaker')
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('councilApp', '0024_discussionquestion_discussionquestionreaction'),
    ]

    operations = [
        migrations.RunPython(clear_users_and_discussions, migrations.RunPython.noop),
    ]
